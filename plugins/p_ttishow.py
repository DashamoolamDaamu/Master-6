...
from utils import get_size, temp, get_settings, get_bot_stats
...
async def get_stats(bot, message):
    if message.from_user.id in ADMINS:
        ...
        stats = await get_bot_stats(client=bot)
        ...
        await rju.edit(script.STATUS_TXT.format(
            stats["total_files"], stats["total_users"], stats["total_chats"],
            size, free,
            stats["cpu_percent"], stats["ram_percent"], stats["ram_used_readable"], stats["ram_total_readable"],
            ping_display, stats["uptime_str"],
        ))
    else:
