...
async def deletemultiplefiles(bot: Client, message: Message):
    ...
    confirm_button = styled_button("Yes, Continue !", callback_data=f"confirm_delete_files#{keyword}")
    abort_button = styled_button("No, Abort operation !", callback_data="close_message")
